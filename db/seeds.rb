...
#Restaurant
r = Restaurant.create!(name: "Mardinis", hours_of_operation: "9am - 9pm", address: "408 Willow Rd, Menlo Park, CA 94025", phone: "(650)324-416", description: "Mardinis--a Mediterranean and American restaurant that does their best to provide guests with good falafels, kabobs and lamb gyro. Delicious Burgers, cold and hot sandwiches, salads and much more.Professional service is a strong point that plays a great role for the success of this restaurant. Mardini's Deli Cafe is famous for its cozy atmosphere. Rated on Google rating as 4.4 stars.")

# {restaurant: r,name: "", description: "", price: , image: ""},
MenuItem.create!([
  #Wraps
  { restaurant: r, name: "Lamb and Beef Gyro Wrap", description: "Tzatziki sauce, lettuce, tomatoes and onions.", price: 16.25, image: "https://s3-media0.fl.yelpcdn.com/bphoto/-yKYMrCbJcmSrdf-Depflg/o.jpg" },
  { restaurant: r, name: "Chicken Shawarma Wrap", description: "Hummus, cucumbers, tomatoes, onions, pickles, tahini sauce & garlic sauce. Served on lavash bread.", price: 17.50, image: "https://i.imgur.com/lypIHOa.jpg" },
  { restaurant: r, name: "Falafel Wrap", description: "Vegetarian. Hummus, cucumbers, tomatoes, onions, pickles & tahini sauce. Served on lavash bread.", price: 14.75, image: "https://img.cdn4dd.com/p/fit=cover,width=600,format=auto,quality=50/media/photosV2/f4c56adf-203b-43bd-aa73-cf85958a5de2-retina-large.JPG" },
  { restaurant: r, name: "Chicken Gyro Wrap", description: "Tzatziki sauce, lettuce, tomatoes & onions. Served on lavash bread.", price: 17.50, image: "https://img.cdn4dd.com/p/fit=cover,width=600,format=auto,quality=50/media/photosV2/1ab6f457-1be1-42f4-bf43-25e48d40e01d-retina-large.JPG" },
  ...
  { restaurant: r, name: "Kufta Wrap", description: "Hummus, cucumbers, tomatoes, onions, pickles & tahini sauce. Served on lavash bread.", price: 17.50, image: "https://popmenucloud.com/cdn-cgi/image/width%3D1200%2Cheight%3D1200%2Cfit%3Dscale-down%2Cformat%3Dauto%2Cquality%3D60/qbpnelod/66e4385d-1148-4a8b-be24-6ff529222d99.JPG" },
  { restaurant: r, name: "Hummus Wrap", description: "Vegetarian. Cucumbers, tomatoes, onions, pickles & parsley. Served on lavash bread.", price: 14.75, image: "https://s3-media0.fl.yelpcdn.com/bphoto/-8Smg_FZxkqqZxzkJ95s8g/348s.jpg" },
  { restaurant: r, name: "Dolmas Wrap", description: "Hummus, cucumbers, tomatoes, onions, pickles, tahini sauce & feta cheese. Served on lavash bread. Served on lavash bread.", price: 14.75, image: "https://img.cdn4dd.com/p/fit=cover,width=600,format=auto,quality=50/media/photosV2/d64dd8b0-bf6e-4e34-b875-0ce84c238ec7-retina-large.JPG" },
  #plates
  { restaurant: r, name: "Lamb & Beef Gyro Plate", description: "Plate come with side of hummus, house salad, rice & pita bread.", price: 20.75, image: "https://img.cdn4dd.com/p/fit=cover,width=600,format=auto,quality=50/media/photos/5fff8497-90c2-4a4f-9fc7-c06d79ec1016-retina-large.jpg" },
  { restaurant: r, name: "Chicken Shawerma Plate", description: "Plate come with side of hummus, house salad, rice & pita bread.", price: 20.75, image: "https://img.cdn4dd.com/p/fit=cover,width=600,format=auto,quality=50/media/photos/4571368f-9e1c-4bbb-814b-1c02e0129e3a-retina-large.jpg" },
