...
MenuItem.create!([
  ...
  #grilled
  { restaurant: r, name: "Philly Cheese Steak Sandwich", description: "", price: 17.75, tag: "grilled" },
  { restaurant: r, name: "Turkey Melt Sandwich", description: "", price: 17.50, tag: "grilled" },
  { restaurant: r, name: "Tuna Melt Sandwich", description: "", price: 17.50, tag: "grilled" },
  { restaurant: r, name: "BBQ Chicken Sandwich", description: "", price: 17.50, tag: "grilled" },
  { restaurant: r, name: "Hot Pastrami Sandwich", description: "", price: 17.50, tag: "grilled" },
  { restaurant: r, name: "Pesto Chicken Sandwich", description: "", price: 17.50, tag: "grilled" },
  { restaurant: r, name: "Cajun Chicken Sandwich", description: "", price: 17.50, tag: "grilled" },
  { restaurant: r, name: "Reuben Sandwich", description: "", price: 17.50, tag: "grilled" },
  { restaurant: r, name: "BLT Sandwich", description: "", price: 16.50, tag: "grilled" },
  { restaurant: r, name: "Honey Pineapple Chicken Sandwich", description: "", price: 17.50, tag: "grilled" },
  { restaurant: r, name: "Chicken Club Sandwich", description: "", price: 17.50, tag: "grilled" },
  { restaurant: r, name: "Veggie Sandwich", description: "Vegetarian. With eggplant, onions, tomatoes & balsamic vinegar.", price: 17.50, tag: "grilled" },
  #cold sandwiches
  { restaurant: r, name: "Club Sandwich", description: "Turkey, avocado, bacon and cheese. Sandwiches come with mayonnaise, mustard, lettuce, tomatoes, onions pickles & pepperoncini.", price: 14.75, tag: "cold" },
  { restaurant: r, name: "Turkey Sandwich", description: "", price: 14.75, tag: "cold" },
  { restaurant: r, name: "Roast Beef Sandwich", description: "", price: 14.75, tag: "cold" },
  { restaurant: r, name: "Italian Sub Sandwich", description: "", price: 15.25, tag: "cold" },
  { restaurant: r, name: "Egg Salad Sandwich", description: "", price: 14.75, tag: "cold" },
  { restaurant: r, name: " Tuna Salad Sandwich", description: "", price: 14.75, tag: "cold" },
  { restaurant: r, name: "Pastrami Sandwich", description: "", price: 14.75, tag: "cold" },
  { restaurant: r, name: "Veggie Sandwich", description: "", price: 14.75, tag: "cold" },
  { restaurant: r, name: "Ham Sandwich", description: "", price: 14.75, tag: "cold" },
